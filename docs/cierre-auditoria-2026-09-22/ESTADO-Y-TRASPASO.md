...
1. **A20:** ORD-02/11, PRD-06 y PRD-17 tienen implementación y pruebas locales. Restan CLI-08, ORD-06/07, PRD-09/15, PLA-05/06, AR-01/02/08/09/16 y CFG-04/12. Reconciliar e implementar las brechas individuales indicadas por `hallazgos.json` y `matriz-164.csv`; no declarar completo un ID por una prueba parcial.
