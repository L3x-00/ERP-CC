...
| A20 (AR-01, referencia parcial) | Ver historial de esta rama | Referencia interna INVCNC única, inmutable y visible en cartera/recibos |
...
1. **A20:** ORD-02/11, PRD-06/17 y CFG-04 tienen implementación y pruebas locales; AR-01 solo incorporó su referencia interna y sigue parcial. Restan CLI-08, ORD-06/07, PRD-09/15, PLA-05/06, AR-01/02/08/09/16 y CFG-12. Reconciliar e implementar las brechas individuales indicadas por `hallazgos.json` y `matriz-164.csv`; no declarar completo un ID por una prueba parcial.
