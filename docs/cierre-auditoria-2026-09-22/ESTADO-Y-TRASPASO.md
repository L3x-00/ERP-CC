...
| A20 (parcial: PRD-06/17) | Ver historial de esta rama | Reanudación contextual con CAS; historial de intervalos sin adjuntos por sesión todavía |
...
1. **A20:** ORD-02/11 y PRD-06 tienen implementación y pruebas locales; PRD-17 dispone del historial pero faltan los adjuntos de sesión. Restan CLI-08, ORD-06/07, PRD-09/15/17, PLA-05/06, AR-01/02/08/09/16 y CFG-04/12. Reconciliar e implementar las brechas individuales indicadas por `hallazgos.json` y `matriz-164.csv`; no declarar completo un ID por una prueba parcial.
