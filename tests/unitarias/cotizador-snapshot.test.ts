...
describe('persistencia del cálculo técnico', () => {
  it('conserva la partida comercial al leer un cálculo inválido o desactualizado', () => {
    const fila = { id: 'qa', pipeline_id: 'qa', descripcion: 'Pieza anterior', cantidad: 2, precio_unitario: 62.5, material: null, espesor: null, area: null, procesos: [], orden: 0, creado_en: '', calculo_tecnico: { version: 1, entrada } };
